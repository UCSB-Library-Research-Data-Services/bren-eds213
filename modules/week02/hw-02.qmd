...
**Please use Canvas to return the assignments: <https://ucsb.instructure.com/courses/32934/assignments/469423>{target="_blank"}**
...
- The code should perform the data cleaning steps described above to enable ingestion into a database (50 pts; Technical concepts)

**Note**: We recommend starting by importing the csv file with the corrected `Snow_cover` column (`data/processed/snow_cover.csv`) we generated during class (my code [here](https://github.com/brunj7/bren-meds213-data-cleaning/blob/main/data-cleaning_empty.qmd))

Finally, remember there are many correct ways of doing this, thus the importance of capturing and discussing your decision process.
