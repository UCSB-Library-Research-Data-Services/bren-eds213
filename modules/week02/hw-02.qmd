...
**Note**: We recommend to start by reading in the csv file with the corrected `Snow_cover` column (`data/processed/snow_cover.csv`) we generated during class (my code [here](https://github.com/UCSB-Library-Research-Data-Services/bren-meds213-data-cleaning/blob/later/data-cleaning.qmd))
