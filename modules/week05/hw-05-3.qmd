...
-   Division. Bash does not support floating point numbers, so you'll have to use a helper program. Take yer pick depending on what's available to you. Let's say you want to divide 10 by 3 (you will want to reference variables in your computation, but here we're just illustrating dividing two literal numbers). You might say something like:
