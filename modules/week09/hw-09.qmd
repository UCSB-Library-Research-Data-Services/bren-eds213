...
Your team has successfully obtained a dataset[^1] that encompasses whale entanglement data associated with specific fisheries along the West Coast. This dataset, named [whale-sdc.csv](whale-sdc.csv), and an accompanying file called [whale-exercise.Rmd](whale-sdcexercise.Rmd).
