...
The dataset has **`r nrow(whale)` rows** and **`r ncol(whale)` columns**. Each row is one entanglement event.
...
**Answer:** _Your answer here. List the variables and explain why each is a QID._
...
**Q4.2 answer — What share of records currently violate 3-anonymity?** _Your answer here._
...
**Q5.2 answer — How many records still violate 3-anonymity after running `kAnon()`?** _Your answer here._
...
**Q6 answer — Which variable had the most suppression, and what does that tell you about the data?** _Your answer here._
