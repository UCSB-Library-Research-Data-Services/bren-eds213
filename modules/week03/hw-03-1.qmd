...
**Please use Canvas to return the assignments: <https://ucsb.instructure.com/courses/32934/assignments/471008>**

It's a useful skill in life (I'm not being rhetorical, I really mean that, it's a useful skill) to be able to construct an experiment to answer a question. Often that can be the most direct way of getting the true answer.
