...
4.  Add this folder to your path `C:\Users\YOUR_USERNAME\AppData\Local`
    ...
    c.  Add New Path: In the Edit Environment Variable window, click the "New" button. Type the full directory path of the program you want to add. Press "Enter" to confirm the path. ![](img/duckdb-windows_path.png)
