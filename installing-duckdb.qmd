...
If you do not get the same answers, then you will have to edit the setting in VS Code. For more information please read <https://code.visualstudio.com/docs/supporting/troubleshoot-terminal-launch>
