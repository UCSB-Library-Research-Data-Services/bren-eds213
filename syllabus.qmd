...
- Lab: Wednesday 1 pm - 2:20 pm in BH 3022 
- Office hours: 
  - Julien & Greg: Tue after class in Oak room 
...
Your performance in this course will depend 90% on weekly homework assignments (including 15% for the discussion project) and 10% on class participation. There will be no graded exercises or homework on week 8 & 9 due to capstones. We will use Canvas to manage the assignments.
...
## Homework policy update May 22

To provide more flexibility in the assignments schedule and accommodate for capstone deadlines, all students will have the opportunity to submit missing assignments as follow:

- You can submit any missing assignments to get **up to 50% of the total points possible** (e.g for a assignment with 100pts, it would mean 50pts for an entirely correct submission)
- "Week4 - missing data" is **excluded** because the answer was discussed in class
- **Due date** for those submissions: **Fri June 6 11:59PM** (end of week 10)
- Submission via Canvas + email to Julien & Greg
- The grade on those submissions will be final


### Acknowledgment of tools used

The use of AI assistant technologies falls within the purview of the Student Conduct Code and the [Student Guide to Academic Integrity](https://studentconduct.sa.ucsb.edu/academic-integrity). It states that “Materials (written or otherwise) submitted to fulfill academic requirements must represent a student’s efforts unless otherwise permitted by an instructor.” Therefore, we expect students to disclaim the use of any coding assistant or LLMs (such as ChatGPT) and to write and understand every line of code that is submitted as part of the assignments. We expect those tools to be used similarly to how Google or StackOverflow could be. In other words, copy-pasting answers without taking the time to understand and modify the suggested code to make it yours is not an acceptable practice. As you are building your skills in SQL and databases, we recommend refraining from the use of AI and keeping to practicing your skills and favoring peer-to-peer learning.
