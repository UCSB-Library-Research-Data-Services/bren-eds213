...
| 3    | [Introdutcion to SQL & DuckDB + bash refresh](modules/week03/index-03.qmd)            |
| 4    | [Importing data in the database + SQL part2](modules/week04/index-04.qmd)          |
| 5    | [Analyzing the bird database using SQL + advanced topics (indexing, ...)](modules/week05/index-05.qmd)   |
